...
describe Event do
  ...
  describe '#add_food_truck' do
    it 'adds a food truck to food_trucks array' do
      event = Event.new("South Pearl Street Farmers Market")
  ...
  describe '#all_items' do
    it 'returns a list of all items available at the event' do
      event = Event.new("South Pearl Street Farmers Market")
      food_truck1 = FoodTruck.new("Rocky Mountain Pies")
      food_truck2 = FoodTruck.new("Ba-Nom-a-Nom")
      food_truck3 = FoodTruck.new("Palisade Peach Shack")
      ...
      expect(event.all_items.length).to eq 4
    end
  end

  describe '#sorted_item_list' do
    it 'returns of all items FoodTrucks have in stock, sorted by name' do
      event = Event.new("South Pearl Street Farmers Market")
      food_truck1 = FoodTruck.new("Rocky Mountain Pies")
      food_truck2 = FoodTruck.new("Ba-Nom-a-Nom")
      food_truck3 = FoodTruck.new("Palisade Peach Shack")
  ...
  describe '#total_quantity' do
    it 'returns total quanitity of item for Event' do
      event = Event.new("South Pearl Street Farmers Market")
      food_truck1 = FoodTruck.new("Rocky Mountain Pies")
      food_truck2 = FoodTruck.new("Ba-Nom-a-Nom")
      food_truck3 = FoodTruck.new("Palisade Peach Shack")
  ...
  describe '#overstocked?' do
    it 'returns true if item is overstocked for event' do
      event = Event.new("South Pearl Street Farmers Market")
      food_truck1 = FoodTruck.new("Rocky Mountain Pies")
      food_truck2 = FoodTruck.new("Ba-Nom-a-Nom")
      food_truck3 = FoodTruck.new("Palisade Peach Shack")
